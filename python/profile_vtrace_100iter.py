...
def run_profiling_test():
    ...
    # Parse args with game_setting=0 and device_id=0
    args = tyro.cli(Args)
    args.game_setting = 0  # Force game_setting=0
    args.device_id = 0     # Force GPU 0
    ...
    # Pre-allocate GPU buffers for distribution parameters
    dist_params_buffer = {
...
if __name__ == "__main__":
    ...
    print("Using game_setting=0, GPU 0")
