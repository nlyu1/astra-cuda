...
2. [Normal game](https://wandb.ai/lyuxingjian-na/HighLowTrading/runs/9zealwey)
...
CUDA_VISIBLE_DEVICES=0 python vtrace.py --game_setting 0 --entropy_coef 0.01 --psettlement_coef 0.1 --proles_coef 0.1  --num_iterations 40000000 --exp_name normal0 --checkpoint_name normal_seedpool_4000
```
