...
CUDA_VISIBLE_DEVICES=0 python vtrace_baseline.py --ent_coef 0.1 --num_iterations 3100 --iterations_per_heavy_logging 500 --iterations_per_checkpoint 3000 --exp_name normalgame_seedpool
